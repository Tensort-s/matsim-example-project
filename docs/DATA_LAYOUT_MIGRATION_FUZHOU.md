...
The project now keeps first-level `data/` domains stable and adds a city layer underneath them.
...
For a compact current-state overview, read `docs/PROJECT_ONBOARDING.md`.
